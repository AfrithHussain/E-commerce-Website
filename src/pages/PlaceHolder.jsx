...
<div className="w-full mt-12">
  ...
  <div className="flex flex-col md:flex-row gap-5 mt-5 items-center md:items-start">
    ...
    >
      <div className="flex items-center gap-4">
        <p className={`rounded-full border shadow w-4 h-4 ${paymentColorChange === "stripe" ? "bg-green-700" : ""}`}></p>
        <img className="w-16" src={Stripe} alt="Stripe Logo" />
      </div>
    </div>
    ...
    >
      <div className="flex items-center gap-4">
        <p className={`rounded-full border shadow w-4 h-4 ${paymentColorChange === "razor" ? "bg-green-700" : ""}`}></p>
        <img className="w-16 py-2" src={Razorpay} alt="Razorpay Logo" />
      </div>
    </div>
    ...
    >
      <div className="flex items-center gap-4">
        <p className={`rounded-full border shadow w-4 h-4 ${paymentColorChange === "cod" ? "bg-green-700" : ""}`}></p>
  ...
  <div className="w-full flex justify-center md:justify-start mt-5">
    <button onClick={()=> navigation('/orders')} className="bg-black text-white p-3 px-5 w-full md:w-auto">
      PLACE ORDER
    </button>
  </div>
</div>
