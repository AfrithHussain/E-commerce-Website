  ...
  return (
    <div className="mt-32 ">
        ...
        <div className="flex justify-center  items-center gap-5">
            <h1 className='prata-regular text-xl md:text-2xl  xl:text-[32px]'>Latest Collections</h1>
          ...
          <div className="flex justify-evenly gap-6 mx-20 mt-16 items-center flex-wrap">
            {
                LatestCollection.map((data,value)=>(
                    <ProductItem key={value} image={data.image} name={data.name} price={data.price} id={data._id}/>
                ))
            }
          </div>
