    ...
    <div className="px-4 sm:px-10">
      ...
      <div className="mt-10 flex flex-col lg:flex-row lg:justify-evenly lg:items-start">
        ...
        <div className="mt-6 lg:mt-0 lg:w-1/3">
          <h1 className="font-semibold text-2xl md:text-[25px]">{singleProductData?.name}</h1>
          ...
          <p className="font-semibold text-3xl md:text-4xl mt-6">{currency}{singleProductData?.price}</p>

          <p className="mt-6 leading-8 text-neutral-600 text-lg">{singleProductData?.description}</p>
          ...
          <div className="flex gap-3 items-center mt-6">
            {singleProductData?.sizes.map((size, index) => (
              <div 
                ...
                onClick={() => setSelectedSize(selectedSize === size ? null : size)} // Toggle size selection
              >
                {size}
              </div>
            ))}
      ...
      <div className="mt-28">
        <div className="flex justify-center md:justify-start items-center gap-2 md:gap-4 lg:gap-2 mx-10">
          <h1 className='prata-regular text-xl md:text-2xl text-neutral-700'>Similar Products</h1>
