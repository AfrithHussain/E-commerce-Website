      ...
      <footer className="bg-white text-black">
        <div className="flex flex-col gap-10 lg:gap-20 lg:flex-row flex-wrap justify-center lg:justify-evenly items-center w-full">
          ...
          <div className="w-full lg:w-auto text-center lg:text-left">
            <h2 className="text-2xl font-bold">VOGUE VIBE<span className="text-green-600 ml-1">.</span></h2>
            <p className="text-xs max-w-[90%] leading-6 md:text-sm mt-4 outfit text-neutral-600 md:max-w-[600px] md:leading-9 break-words">
              Vogue vibe is your go-to destination for elegant and trendy fashion.
              We bring you a curated collection of the latest styles, ensuring
              you feel confident and look stunning for every occasion. Step into the world
              of fashion that speaks to your personality and celebrates your unique style.
            </p>
          </div>
