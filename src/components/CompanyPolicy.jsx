      ...
      <div className="mt-32">
        ...
        <div className="mt-20 flex justify-evenly  gap-20 flex-wrap">
          ...
          <div className="flex flex-col justify-center items-center gap-2">
            <LazyLoadImage src={Exchange} className="w-12" alt="" />
            <p className=" outfit   text-xl">Best Exchange Policy</p>
            <p className="outfit text-[16px] text-neutral-500 font-semibold">
              We offer hassle free exchange policy
            </p>
          </div>
          {/* div 2  */}
          <div className="flex flex-col justify-center items-center gap-2">
            <LazyLoadImage src={Quality} className="w-12" alt="" />
          ...
          {/* div 3 */}
          <div className="flex flex-col justify-center items-center gap-2">
            <LazyLoadImage src={Support} className="w-12" alt="" />
